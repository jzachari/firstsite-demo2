...
export default function decorate(block) {
  ...
  let floatemojitext = document.createTextNode("Click an emoji to react to the page.");
...
//   x.addEventListener("click", myMove);
  ...
  let emoji = document.createTextNode("❤️");
  ...
  let new_div3 = document.createElement("div");
    ...
    new_div.appendChild(new_div3);
      let emojimirror = document.createTextNode("❤️");
  ...
  let emoji2 = document.createTextNode("🚀");
  ...
  let second_emoji_div_animate_mirror = document.createElement("div");
    ...
    second_emoji_div.appendChild(second_emoji_div_animate_mirror);
      ...
      let secondemojimirror = document.createTextNode("🚀");
